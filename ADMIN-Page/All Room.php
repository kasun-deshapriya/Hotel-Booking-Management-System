...
<?php
    ...
    $query = "SELECT `Room_No`, `Room_Type`, `Bed_Capacity`, `Room_Description`, `Room_Price`, `Image` FROM `room`";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td><img src="room-img/' . $row['Image'] . '" alt="Room Image"></td>';
        echo '<td>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
            Edit
        </button>
        <a href="RoomDelete.php?deleteCode=' . $row['Room_No'] . '" class="btn1">Delete</a>
