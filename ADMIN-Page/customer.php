          ...
          <ul class="ul">
            ...
            <li>
              ...
              <ul class="submenu-1">
                ...
                <li><a href="Edit Booking">&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-compact-right" viewBox="0 0 16 16">
                  <path fill-rule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
...
<?php
    ...
    $query = "SELECT Customer_NIC, Name, Address, `Contact_Number`, Email FROM customer";
    $result = mysqli_query($conn, $query);
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <a href ="DeletCustomer.php?deleteCode='.$row['Customer_NIC'].'" class="btn1">Delete</a>
...
<div class="container">
  ...
  <div class="container">
    <h1>Customer Data</h1>
    <?php
    // Retrieve customer data from the database based on the provided NIC
    $nic = $_POST['nic'];
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        echo "<p><strong>NIC:</strong> " . $row['Customer_NIC'] . "</p>";
      ...
      echo "<p>No data found for the provided NIC.</p>";
    }
