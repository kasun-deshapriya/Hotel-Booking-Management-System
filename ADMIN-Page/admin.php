...
$sql = "SELECT COUNT(*) as total_rows FROM room";
$result = $conn->query($sql);
...
$sql = "SELECT COUNT(*) as total_rows FROM hall";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $totalRows2 = $row["total_rows"];
} else {
    $totalRows2 = 0;
}

$sql = "SELECT COUNT(*) as total_rows FROM room booking";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $totalRows3 = $row["total_rows"];
} else {
    $totalRows3 = 0;
}
    ...
    <div class="container0">
      <br><br>
        ...
        <div class="container4">
            <img src="images/download.jpg" alt="" class="img4" width="60px" height="60px">
            <br><br><br>
            <label for="" class="label4">Total Coustomer</label><br><br><br>
            <lable name="Coustomer" class="text1">   0<?php echo $totalRows; ?>  </lable> 
  </div>

        <div class="container5">
        
            <img src="images/images.jpg" alt="" class="img4" width="60px" height="60px">
            <br><br><br>
            <label for="" class="label5">Total Room</label><br><br><br>
            <lable name="Coustomer" class="text1">   0<?php echo $totalRows1; ?>   </lable> 
        </div>

        <div class="container6">
            <img src="images/download (7).png" alt="" class="img4" width="60px" height="60px">
            <br><br><br>
            <label for="" class="label5">Total Hall</label><br><br><br>
            <lable name="Coustomer" class="text1">   0<?php echo $totalRows2; ?>   </lable> 
        </div>

        <div class="container7">
            <img src="images/download (8).png" alt="" class="img4" width="60px" height="60px">
            <br><br><br>
            <label for="" class="label5">Total Booking</label><br><br><br>
            <lable name="Coustomer" class="text1">   0<?php echo $totalRows3; ?>  </lable> 
        </div>
